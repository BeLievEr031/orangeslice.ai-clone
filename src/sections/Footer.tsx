...
function Footer() {
    return (
        <footer className="relative flex min-h-[100px] flex-col justify-between  overflow-hidden bg-[#FFD37B] text-black">
            <div className="relative mx-auto w-full max-w-7xl overflow-hidden px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
                <div className="flex justify-center space-x-6 md:order-2">
                    <a className="" href="https://x.com/orangesliceai">
                    ...
                    <a
                        ...
                        href="https://www.linkedin.com/company/106441399/"
                    >
